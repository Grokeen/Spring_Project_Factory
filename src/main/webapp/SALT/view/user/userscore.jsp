			...
			<div class="boardSort">
				...
				<table border="1" summary="">
					...
					<tbody
						...
						<c:forEach var="re1" items="${userscore}">
							<tr style="background-color: #FFFFFF; color: #555555;"
								class="xans-record-">
								<td><input class="boardChk" value="1" type="checkbox" />${re1.RANK}</td>
								<td class="subject"><a
									href="<%=request.getContextPath()%>/employee/userscore2?deptname=${re1.DEPTNAME}&empno=${login}">${re1.DEPTNAME}</a>
								</td>
								<td></td>
								<td class="txtLess "></td>
